...
testing_1.describe('RestCollection Specs New', function () {
    testing_1.it('should load a list of items', function () {
    ...
    testing_1.it('should handle loading a list of items failure', function () {
    ...
    testing_1.it('should load a single item', function () {
        var response = new http_1.Response(new http_1.ResponseOptions({ body: { id: 1, value: 'value 1' } }));
        var mockCollectionService = new MockCollectionService(new mock_http_1.MockHttp(response));
        mockCollectionService.collection$
            .skip(1)
            .do(function (items) { return testing_1.expect(items[0].id).toBe(1); })
            .subscribe();
        mockCollectionService.load(1);
    });
    testing_1.it('should handle loading a item failure', function () {
        var response = new http_1.Response(new http_1.ResponseOptions({ status: 404 }));
        var mockCollectionService = new MockCollectionService(new mock_http_1.MockHttp(new Error('ERROR')));
        mockCollectionService.errors$
            .skip(1)
    ...
    testing_1.it('should create a item', function () {
        var response = new http_1.Response(new http_1.ResponseOptions({ body: { id: 1, value: 'value 1' } }));
        var mockCollectionService = new MockCollectionService(new mock_http_1.MockHttp(response));
        mockCollectionService.collection$
            .skip(1)
    ...
    testing_1.it('should handle creating a item failure', function () {
        var response = new http_1.Response(new http_1.ResponseOptions({ status: 404 }));
        var mockCollectionService = new MockCollectionService(new mock_http_1.MockHttp(new Error('ERROR')));
        mockCollectionService.errors$
            .skip(1)
    ...
    testing_1.it('should update a item', function () {
    ...
    testing_1.it('should handle updating a item failure', function () {
        var response = new http_1.Response(new http_1.ResponseOptions({ status: 404 }));
        var mockCollectionService = new MockCollectionService(new mock_http_1.MockHttp(new Error('ERROR')));
        mockCollectionService.errors$
            .skip(1)
    ...
    testing_1.it('should remove a item', function () {
    ...
    testing_1.it('should handle removing a item failure', function () {
        var response = new http_1.Response(new http_1.ResponseOptions({ status: 404 }));
        var mockCollectionService = new MockCollectionService(new mock_http_1.MockHttp(new Error('ERROR')));
        mockCollectionService.errors$
            .skip(1)
    ...
    testing_1.it('should allow a subscription of errors', function () {
        var response = new http_1.Response(new http_1.ResponseOptions({}));
        var mockCollectionService = new MockCollectionService(new mock_http_1.MockHttp(response));
        mockCollectionService.errors$
            .do(function (err) { return testing_1.expect(err).toBeDefined(); })
    ...
    testing_1.it('should allow a subscription of history', function () {
        var response = new http_1.Response(new http_1.ResponseOptions({}));
        var mockCollectionService = new MockCollectionService(new mock_http_1.MockHttp(response));
